...
<body>
<form action="all.php" class="bomber-form" method="POST">
    <?php
    ...
    <a href="https://github.com/DarkCodeTeam" target="_blank"><img alt="AmirMalek-Github" class="git" src="assets/img/github.png"></a>
